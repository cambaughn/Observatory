...
Produces data/processed/nc_population_2020.csv (NAME, pop2020).
...
The 382MB state download is the one heavy step; it is cached in data/raw/
...
OUT = Path(__file__).resolve().parent.parent / "data" / "processed" / "nc_population_2020.csv"
