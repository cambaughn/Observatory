...
`shared/templates/field_visit_template.md` (copy into `field-notes/` per site, or one per day with
site headers). Universal checklist: **land use · alley/frontage · lighting ·
cameras · signage · bin access · encampment proximity · pile present now? ·
signs of cleanup/recurrence**.
...
After the day: notes → `field-notes/`, durable answers → tracker
(RT-01/02/03/07/08/09), surprises → next notebook's questions.


---

## Print-Ready Site Checklist (clipboard spare)

One generic copy for paper use — print a few, fill in the site by hand.
