"""Download MyLA311 data from the LA Open Data Portal into shared/datasets/raw/.

Usage:
    python shared/scripts/download_myla311.py            # current-system 2026 data
    python shared/scripts/download_myla311.py 2024       # any year in DATASETS
